...
1. **RAG** — Guías clínicas PDF (HTA, DM2, hábitos) + vademecum
...
- ⬜ Fase 2: Grafo LangGraph multi-agente con orquestador
...
- Las tools devuelven strings formateados con emojis para UX
