...
PROMPT_MEDICO = (
    ...
    "antes de ejecutar). Para CONSULTAS de pacientes: usá `responder_consulta` con la respuesta "
    "del médico (NO aprobar/rechazar). En ambos casos el paciente recibe un email automático.\n"
